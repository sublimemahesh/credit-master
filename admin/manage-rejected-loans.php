...
<html>
    <head>
        ...
        <title>Manage Rejected Loan || Credit Master</title>
                                            ...
                                            foreach ($LOAN->allByStatus() as $key => $loan) {
                                                ...
                                                <tr id="row_<?php echo $loan['id']; ?>">
                                                    ...
                                                    <td class="text-center" style="padding-top: 24px;">
                                                        <a href="back-to-verify-loan.php?id=<?php echo $loan['id']; ?>"><button class="glyphicon glyphicon-backward btn btn-info" title="Back to Verify Loan #<?php echo str_pad($loan['id'], 6, '0', STR_PAD_LEFT); ?>"></button></a> |  
