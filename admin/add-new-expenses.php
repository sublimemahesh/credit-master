...
<html> 
    <head>
        ...
        <title>Add New Expenses || Credit Master</title>
        <!-- Favicon-->
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 p-bottom">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="time" id="paid_date"  name="time" placeholder="Enter Time" class="form-control  " autocomplete="off" required="TRUE"  >
                                        </div>
                                    </div>
                                </div>
                            </div>
