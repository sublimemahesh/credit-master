                                        ...
                                        <tbody>
                                            ...
                                            foreach ($OD->getOdByLoanId($loan_id) as $key => $od) {
                                                ...
                                                <tr id="row_<?php echo $od['id']; ?>">
                                                    ...
                                                    <td><?php echo $od['od_date_end']; ?></td> 
                                                    <td><?php echo number_format($od['od_interest_limit'], 2); ?></td> 
                                                    <td>
                                                        <a href="edit-customer.php?id=<?php echo $od['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn" title="Edit"></button></a> | 
                                                        <a href="#"  class="delete-customer" data-id="<?php echo $od['id']; ?>"> <button class="glyphicon glyphicon-trash delete-btn" title="Delete"></button></a>
