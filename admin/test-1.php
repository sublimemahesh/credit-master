...
//                    $balance = $paid_all_od_before_ins_date + $paid_all_amount_before_ins_date - $ins_total - $od_total_amount;
            ...
            foreach ($INSTALLMENT->getOtherPaymentByLoan($this->id) as $installment_type) {
            ...
            if ($this->issue_mode == 'bank') {
                
            } else {
                $balance = $this->loan_amount + $balance;
            }

            if ($this->balance_of_last_loan) {
                $balance = $balance - $this->balance_of_last_loan;
            }


            $balance = $balance - $this->loan_processing_pre;
                        ...
                        if ($od !== false) {
                            ...
                            while ($y <= $defult_val) {
                                ...
                                if (strtotime(date("Y/m/d")) <= strtotime($od_date)) {
                                    ...
                                    foreach ($INSTALLMENT->CheckInstallmetBeetwenTwoDateByLoanId($od_night, $ss, $this->id) as $Installment_payment) {
...
//
//
//                                foreach ($INSTALLMENT->CheckInstallmetBeetwenTwoDateByLoanId($old_od_date, $installment_unlimited_end, $this->id) as $Installment_payment) {
//
//                                    $before_all_balnce_amount = $balance + $Installment_payment['paid_amount'];
////                          
//                                    $balance = $balance + $Installment_payment['paid_amount'] + $Installment_payment['additional_interest'];
...
//                                        $dd = ($od_amount - $od_total_amount);
//                                    }
//                                    number_format($balance - ($dd), 2);
//                                }
//                                break;
//                            }
//
//                            //receipts between two od dates 
//                            foreach ($INSTALLMENT->CheckInstallmetBeetwenTwoDateByLoanId($old_od_date, $od_date1, $this->id) as $Installment_payment) {
//
//
//                                $before_all_balnce_amount = $balance + $Installment_payment['paid_amount'];
//
...
//                                foreach ($INSTALLMENT->CheckInstallmetBeetwenTwoDateByLoanId($od_date1, $installment_unlimited_end, $this->id) as $Installment_payment) {
//
//                                    $before_all_balnce_amount = $balance + $Installment_payment['paid_amount'];
////                                                                $balance = $balance + $Installment_payment['paid_amount'] + $Installment_payment['additional_interest'];
//                                    if (($od_amount - $od_total_amount) < 0) {
...
//                                foreach ($INSTALLMENT->CheckInstallmetBeetwenTwoDateByLoanId($od['od_date_end'] . ' 23:59:59', $installment_unlimited_end, $this->id) as $Installment_payment) {
//
//                                    $before_all_balnce_amount = $balance + $Installment_payment['paid_amount'];
//
//                                    $balance = $balance + $Installment_payment['paid_amount'] + $Installment_payment['additional_interest'];
