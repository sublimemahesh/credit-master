                        ...
                        <form class="" action="" method="post"  enctype="multipart/form-data" id="form-data"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p-bottom">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="number" id="paid_amount"  name="paid_amount" placeholder="Select the date" class="form-control"   autocomplete="off" min="0" step="0.001" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p-bottom">
                                    <div class="form-group">
                                        <div class="form-line">                                            
                                            <input type="text" id="od_limite"  name="od_limite"  placeholder="Od Limite" class="form-control"   autocomplete="off" >
                                        </div>
                                    </div>
                                </div>
                            </div> 
