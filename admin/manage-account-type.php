...
<html>
    ...
    <head>
        ...
        <title>Manage Account Type || Credit Master</title>
    ...
    <body class="theme-red">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($ACCOUNT_TYPE->all() as $key => $account_type) {
                                                ?>
                                                <tr id="row_<?php echo $account_type['id']; ?>">
                                                    <td>#<?php echo $account_type['id']; ?></td>  
                                                    <td><?php echo $account_type['name']; ?></td>  
                                                    <td>
                                                        <a href="add-new-branch.php?id=<?php echo $account_type['id']; ?>"> <button class="glyphicon glyphicon-home  arrange-btn" title="Branch"></button></a> | 
        ...
        <script src="delete/js/account-type.js" type="text/javascript"></script>
    </body> 
</html> 